...
import bstConstrcution
import unittest


test1 = bstConstrcution.BST(10).insert(5).insert(15).insert(5).insert(2).insert(14).insert(22)

test2 = bstConstrcution.BST(10).insert(15).insert(11).insert(22).remove(10)

test3 = bstConstrcution.BST(10).insert(5).insert(7).insert(2).remove(10)

test4 = (
    bstConstrcution.BST(10)
    .insert(5)
    .insert(15)
    .insert(22)
    .insert(17)
...
class TestbstConstrcution(unittest.TestCase):
